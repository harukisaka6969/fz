...
import { loginAdminAction, type LoginState } from "@/lib/actions/auth-actions";
...
export default function AdminLoginForm() {
  ...
  return (
    <form action={formAction} className="space-y-4">
      <div>
        <label htmlFor="username" className="block text-sm font-medium text-brand-900">
          ユーザー名
        </label>
        <input
          id="username"
